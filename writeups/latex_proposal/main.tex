...
{\large School of Computing and Information Technology}\\[1.5cm]

{\LARGE \textbf{A Blockchain-Secured Federated Learning System for Detection and Early Warning of Foot-and-Mouth Disease in Ugandan Cattle Farms}}\\[0.8cm]

{\Large \textit{Research Proposal}}\\[1cm]

{\large \textbf{By}}\\[0.5cm]
{\Large Muhindo Mubaraka}\\[0.3cm]
{\large Student Number: 2400725633}\\[0.2cm]
{\large Registration Number: 2024/HD05/25633U}\\[0.2cm]
{\large \textit{muhindo.mubaraka@students.mak.ac.ug, mubahood360@gmail.com}}\\[1cm]

{\large \textbf{Supervisor}}\\[0.3cm]
{\large Dr. Chongomweru Halimu}\\[0.2cm]
{\large School of Computing and Information Technology}\\[1cm]

{\Large \textbf{A Research Proposal Submitted in Partial Fulfillment of the Requirements for the Degree of Master of Computer Science}}\\[0.8cm]
...
\noindent
I Muhindo Mubaraka hereby declare that this research proposal is my own work and effort and that it has not been submitted anywhere for any award. Where other sources of information have been used, they have been acknowledged.

\vspace{2cm}

\noindent
\textbf{Student Name:} Muhindo Mubaraka\\[0.5cm]
\textbf{Student Number:} 2400725633\\[0.5cm]
\textbf{Registration Number:} 2024/HD05/25633U\\[1cm]

\noindent
\textbf{Signature:} \rule{5cm}{0.5pt}\\[0.5cm]
...
This research proposal titled \textbf{"A Blockchain-Secured Federated Learning System for Detection and Early Warning of Foot-and-Mouth Disease in Ugandan Cattle Farms"} has been approved by the following supervisor.

\vspace{2cm}

\noindent
\textbf{Supervisor's Name:} Dr. Chongomweru Halimu\\
...
In Uganda, Foot-and-Mouth Disease is a serious problem that shows why this matters. FMD causes major economic losses for livestock farmers through lower productivity, trade bans, and sick animals. The Uganda Livestock Information Tracking System (ULITS) collects surveillance data across district veterinary offices, but there is no early warning system that can predict outbreaks while keeping data private and building trust between districts \cite{kapalaga2024}. Without such a system, outbreaks are usually found only after they have spread, making it harder to stop them.
...
Table \ref{tab:literature_summary} summarizes the key studies reviewed, highlighting their main contributions and limitations relevant to this research.
...
\subsection{Data Collection, Cleaning, and Preprocessing}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{fmd_diagram.jpeg}
\caption{System Architecture Design showing the layered approach with Data Layer (district databases), Federated Learning Layer (local training and secure aggregation), Blockchain Layer (Hyperledger Fabric with PBFT consensus), and Application Layer (Django backend and React.js dashboard).}
...
\subsection{Practical Effectiveness Assessment}
...
\begin{figure}[!t]
\centering
\textbf{\large Blockchain-Secured Federated Learning for FMD Early Warning System}
\vspace{0.3cm}
\includegraphics[width=\textwidth]{blockchain_fl_workflow.png}
